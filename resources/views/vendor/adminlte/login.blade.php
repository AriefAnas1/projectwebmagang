...
@section('body')
    <div class="login-box">
        <div class="login-logo">
            ...
            <br>
            <img src="logo/logo-attendance.png" width="20%" alt="">
        </div>
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="{{ $login_url }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <button type="submit" class="btn btn-dark btn-block btn-flat" style="background-color: #e11586">
                ...
                @if ($register_url)
                    <p class="mb-0">
                        <a style="color: #e11586" href="{{ $register_url }}">
